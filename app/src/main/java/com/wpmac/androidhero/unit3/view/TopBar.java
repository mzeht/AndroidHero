...
public class TopBar extends LinearLayout {
    ...
    public TopBar(Context context, AttributeSet attrs) {
        ...
        mRightTextColor = ta.getColor(
                R.styleable.TopBar_mrightTextColor, 0);
        mRightBackground = ta.getDrawable(
                R.styleable.TopBar_mrightBackground);
        mRightText = ta.getString(R.styleable.TopBar_mrightText);

        mTitleTextSize = ta.getDimension(
                R.styleable.TopBar_mtitleTextSize, 10);
        mTitleTextColor = ta.getColor(
                R.styleable.TopBar_mtitleTextColor, 0);
